...
public class Main {
    public static void main(String[] args) {
        ...
        Persona coco = new Persona("coco",1);
        Persona lucia = new Persona("lucia",2);

        Sucursal sucursalOrigen = new Sucursal(1, 1);
        Sucursal sucursalDestino = new Sucursal(2, 2);

        Envio envio = new Envio(coco, lucia, 15.2, 1);

        envio.registrarMovimiento(sucursalOrigen);
        System.out.println(envio.buscarUbicacionActual().getNumero());
